...
function chkPass(btn) {
	...
	if (pass.value == 11223344) {
		...
		setTimeout(function() {
			...
			btn.innerHTML = 'Start Test &gt;'; // replace text of input box to this
...
function startQuiz() {
	...
	document.getElementById('theQuiz').style.display = 'block'; //show quiz form
...
function showResult(percentage, ca) {
	if (percentage == 100) {
		RColor = 'red';
		resultFb.innerHTML = 'Oh no! You have Severe Depression <br> Solution : TO CONSULT A DOCTOR as soon as possible';
		//correctAns.innerHTML = 'Correct Answers: ' + ca;
	} else if (percentage >= 80) {
		RColor = 'orange';
		resultFb.innerHTML = 'OOK! You have Moderate Depression <br> Solution : To do yoga regularly <br> To take sleep for atleast 8h <br> To take cold showers for refreshing mind ';
		//correctAns.innerHTML = 'Correct Answers: ' + ca;
	} else if (percentage >= 65) {
		RColor = 'orange';
		resultFb.innerHTML = 'OOK! You have Moderate Depression <br> Solution : To do meditation regularly <br> To fill mind with positive thoughts <br> To listen to joyful music';
		//correctAns.innerHTML = 'Correct Answers: ' + ca;
	} else if (percentage >= 50) {
		RColor = 'orange';
		resultFb.innerHTML = ' You have mild Depression! <br> Solution : To sleep for minimum 8h <br> To listen joyful music';
		//correctAns.innerHTML = 'Correct Answers: ' + ca;
	} else {
		RColor = 'green';
		resultFb.innerHTML = 'Wow You have no Depression!';
		//correctAns.innerHTML = 'Correct Answers: ' + ca;
	}
